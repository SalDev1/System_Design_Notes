    ...
    public void startMatch() {
        ...
        for (int inning = 1; inning <= 2; inning++) {
            ...
            if (inning == 1) {
                ...
                inningDetails = new InnningDetails(battingTeam, bowlingTeam, matchType);
